...
\n \den{[$_{\text{NP}}$ cachorro]} = $\lambda x_{e}.\ \predica{cachorro}{x}$

\n \den{[$_{\text{AP}}$ branco]} = $\lambda x_{e}.\ \predica{branco}{x}$\\
...
\n \den{[$_{\text{NP}}$ cachorro branco]} = $\lambda x_{e}.\ 
...
\n \den{branco} = $\lambda F_{\langle e,t \rangle}.\lambda x_{e}.\
F'(x)\ \&\ \predica{branco}{x}$\\


\n \den{[$_{\text{NP}}$ cachorro branco]} = \den{[$_{\text{AP}}$
...
\n \den{[$_{\text{NP}}$ cachorro branco peludo]} =
\den{[$_{\text{AP}}$ peludo]}(\den{[$_{\text{NP}}$ cachorro branco]})\\
...
\n \den{[$_{\text{NP}}$ cachorro branco peludo]} =
\den{[$_{\text{AP}}$ peludo]}(\den{[$_{\text{AP}}$
branco]}(\den{[$_{\text{NP}}$ cachorro]}))\\

\n \den{[$_{\text{NP}}$ cachorro branco peludo]} = $\lambda x_{e}.\ \predica{cachorro}{x}\ \&\ \predica{branco}{x}\ \&\ \predica{peludo}{x}$\\
...
\n \den{branco} = $\lambda x_{e}.\ \predica{branco}{x}$\\

\n \den{branco$'$} = $\lambda F_{\langle e,t\rangle}.\ F'(x)\ \&\ \predica{branco}{x}$\\

\n O mesmo valeria pra outros adjetivos, como \textit{peludo}, por
exemplo:\\

\n \den{peludo} = $\lambda x_{e}.\ \predica{peludo}{x}$\\

\n \den{peludo$'$} = $\lambda F_{\langle e,t\rangle}.\ F'(x)\ \&\ \predica{peludo}{x}$\\
...
\n \den{[$_{\text{AP}}$ fiel ao João]} = $\lambda x_{e}.\ \predica{fiel}{x,joão}$

\n \den{[$_{\text{AP}}$ fiel ao João]} = $\lambda F_{\langle
e,t\rangle}.\ \lambda x_{e}.\ F'(x)\ \&\ \predica{fiel}{x,joão}$\\

\n \den{[$_{\text{PP}}$ de Campinas]} = $\lambda x_{e}.\ \predica{ser\_de}{x,campinas}$

\n \den{[$_{\text{PP}}$ de Campinas]} = $\lambda F_{\langle
...
\n \den{de Campinas} = \den{de}(\den{Campinas}) = $\lambda y.\ \predica{ser\_de}{y,campinas}$\\
\den{médico} = $\lambda y.\ \predica{médico}{y}$\\
\den{médico de Campinas} = $\lambda y.\ \llbracket \text{médico} \rrbracket = 1\ \&\ \llbracket \text{de Campinas} \rrbracket = 1$ \\
...
\Tree [.DP [.D o ] [.NP [.NP [.N cachorro ] ] [.S\1 que$_1$ [.S [.DP João ] [.VP [.V adora ] [.DP ele$_1$ ] ] ] ] ] ].DP
...
\n \den{cachorro que João adora ele} = $\lambda x.\ \predica{cachorro}{x}\ \&\ \predica{adora}{joão,x}$ \\
...
\Tree [.DP [.D o ] [.NP [.NP [.N cachorro ] ] [.S\2 que [.S\1 1
...
\n \den{S}$^{g}$ = 1 \textit{sse} João adora g(1).\\
...
\n\den{$S'$}$^{g}$ = $\lambda x_{e}. \llbracket \text{S}
...
\n  \den{$S'$}$^{g}$ = $\lambda x.$ \den{adora}$^{g[1 \rightarrow x]}$(\den{ele$_{1}$}$^{g[1 \rightarrow x]}$)(\den{João}$^{g[1 \rightarrow x]}$)\\

\n As extensões do verbo \textit{adorar} e do sujeito \textit{João}, por não conterem pronomes, não apresentam nada de novo:\\

\n\den{adora}$^{g[1 \rightarrow x]}$ = $\lambda x.\lambda y.\ \predica{adora}{y,x}$\\
...
\n\den{ele$_{1}$}$^{g[1 \rightarrow x]}$ = $g[1 \rightarrow x](1)$ = $x$ \\

\n Juntando tudo isso, temos:\\

\n \den{S$'$}$^{g}$ = $\lambda x.\ \predica{adora}{joão,x}$\\
...
\n \den{que$_{\text{\textsc{rel}}}$}$^{g}$ = $\lambda F_{\langle
...
\n\den{S$''$}$^{g}$ = \den{que$_{\text{\textsc{rel}}}$}$^{g}$(\den{S$'$}$^{g}$)

\n \n \den{$S''$}$^{g}$ = $\lambda G_{\langle e,t\rangle}.\lambda
...
\n\den{NP}$^{g}$ = \den{S$''$}$^{g}$(\den{cachorro}$^{g}$)\\
\den{NP}$^{g}$ = $\lambda x_{e}.\ \predica{cachorro}{x}\ \&\
...
\n \den{que$_{1}$ t$_{1}$ mordeu o dono dele$_{2}$}$^{g}$ = $\lambda x.\ \predica{mordeu}{x, o dono de g(2)}$\\
...
\n 2. \den{S$'$}$^{g}$ = $\lambda x.$ \den{S}$^{g[1 \rightarrow x]}$
\hfill (AbF)\\

\n 3. \den{S$''$}$^{g}$ = \den{que}$^{g}$($\lambda x.$ \den{S}$^{g[1 \rightarrow x]}$) \hfill (1,2)\\

\n 4. \den{S}$^{g[1 \rightarrow x]}$ = \den{mordeu o dono
dele$_{2}$}$^{g[1 \rightarrow x]}$(\den{t$_{1}$}$^{g[1 \rightarrow x]}$)
\hfill
(AF)\\

\n 5. \den{mordeu o dono dele$_{2}$}$^{g[1 \rightarrow x]}$ =
\den{mordeu}$^{g[1 \rightarrow x]}$(\den{o dono dele$_{2}$}$^{g[1 \rightarrow x]}$) \hfill (AF)\\

\n 6. \den{mordeu}$^{g[1 \rightarrow x]}$ = $\lambda x.\lambda y.\ \predica{mordeu}{y,x}$ \hfill (L)\\

\n 7. \den{o dono dele$_{2}$}$^{g[1 \rightarrow x]}$ = \den{o}$^{g[1
\rightarrow x]}$(\den{dono dele$_{2}$}$^{g[1 \rightarrow x]}$) \hfill
(AF)\\

\n 8. \den{o}$^{g[1 \rightarrow x]}$ = $\lambda F.\ \iota z[F'(z)]$ \hfill (L)\\

\n 9. \den{dono dele$_{2}$}$^{g[1 \rightarrow x]}$ = \den{dono}$^{g[1
\rightarrow x]}$(\den{dele$_{2}$}$^{g[1 \rightarrow x]}$) \hfill (AF)\\

\n 10. \den{dono}$^{g[1 \rightarrow x]}$ = $\lambda x.\lambda y.\ \predica{dono}{y,x}$ \hfill (L)\\

\n 11. \den{dele$_{2}$}$^{g[1 \rightarrow x]}$ = \den{ele$_{2}$}$^{g[1
\rightarrow x]}$ \hfill (NNR, \textit{de} é vácua)\\

\n 12. \den{ele$_{2}$}$^{g[1 \rightarrow x]}$ = $g[1 \rightarrow x](2)$ = $g(2)$ \hfill (L,
Ass.Mod)\\
...
\n 16. \den{t$_{1}$}$^{g[1 \rightarrow x]}$ = $g[1 \rightarrow x](1)$ = $x$ \hfill (L,Ass.Mod)\\
...
\n 20. \den{que}$^{g}$ = $\lambda F_{\langle e,t\rangle}.\lambda
G_{\langle e,t\rangle}.\lambda x_{e}.\ G'(x)\ \&\ F'(x)$
\hfill (L)\\

\n 21. \den{S$''$}$^{g}$ = $\lambda G_{\langle e,t\rangle}.\lambda
...
\n \den{NP}$^{g}$ = $\lambda x_{e}.\ \predica{cachorro}{x}\ \&\ \textsc{mordeu}(x,\iota x[\textsc{dono}(x,g(2))])$\\
...
\n \den{dele$_{1}$}$^{g[1 \rightarrow x]}$ = $x$ \\

\n \den{S}$^{g[1 \rightarrow x]}$ = 1 \textit{sse} $\textsc{mordeu}(x,\iota z[\textsc{dono}(z,x)])$\\
...
\n \den{NP}$^{g}$ = $\lambda x_{e}.\ \predica{cachorro}{x}\ \&\ \textsc{mordeu}(x,\iota z[\textsc{dono}(z,x)])$\\
